		...
		*/
		...
		function PaperCheckerPanel(props) {
			...
			return react.createElement("div", { style: {
				...
				border: "1px solid var(--dsw-alias-border-l1, #ccc)",
				fontSize: 12
			} }, react.createElement("div", null, "期刊名：" + (discovered.name || "")), react.createElement("div", null, "分区：" + (Array.isArray(discovered.sections) ? discovered.sections.join("、") : "")), react.createElement("div", { style: { marginTop: 6 } }, react.createElement("button", {
				style: s.btn,
				type: "button",
				onClick: addDiscovered
			}, "加入列表"))) : null, react.createElement("div", { style: s.hint }, "自动打开期刊网站登录，用模型识别期刊名与需要跟踪的审稿分区，生成后加入下方期刊列表。")), react.createElement("div", { style: s.row }, react.createElement("label", { style: s.label }, "期刊列表（JSON 数组）"), react.createElement("textarea", {
				style: s.textarea,
				value: journalsText,
